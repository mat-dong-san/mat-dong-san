...
<script>
   function inputValue(){
      document.getElementById("e_name").value = opener.document.getElementById("e_name").value;
      document.getElementById("e_id").value = opener.document.getElementById("e_id").value;
      document.getElementById("p_id").value = opener.document.getElementById("p_id").value;
      document.getElementById("us_id").value = opener.document.getElementById("us_id").value;
   }
