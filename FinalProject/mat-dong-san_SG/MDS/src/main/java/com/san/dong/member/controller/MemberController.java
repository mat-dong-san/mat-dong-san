...
public class MemberController {
	...
	public String mypage_memberManagement() {
		return "mypage";
	}
	
	// 마이페이지-회원관리 - 활동이력
	@RequestMapping("mypage_memberInfo.me")
	public String mypage_mypageMemberInfo() {
		return "mypage_memberInfo";
	}
	
	// 마이페이지- 중개사 관리
	@RequestMapping("mypage_brokerManagement.me")
	public String mypage_brokerManagement() {
	...
	// 마이페이지-신고함
	@RequestMapping("mypage_reported_viewDetails.me")
	public String mypage_reported_viewDetails() {
		return "mypage_reported_viewDetails";
	}
	
	// 마이페이지-신고함-내용보기
	@RequestMapping("mypage_reported.me")
	public String mypage_reported() {
		return "mypage_reported";
	}
