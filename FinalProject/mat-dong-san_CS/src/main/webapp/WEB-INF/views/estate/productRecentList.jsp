...
<body>
	...
	<input type="button" class="btn" value="선택삭제" id="deleteBtn"><input type="button" class="btn" value="찜하기" id="takeBtn"> 
	<br><br><br><br>
	...
	<script>
      ...
      $("#takeBtn").click(function(){
          ...
          var confirm_val = confirm("찜하시겠습니까?");
          if(confirm_val) {
        	  alert('찜완료');
        	  $.ajax({
  				url:'selectedTakeCheck.es',
  				data:{selectedCheck:selectedCheck},
  				success:function(data){
  					console.log(data);
  					if(data == "1"){
