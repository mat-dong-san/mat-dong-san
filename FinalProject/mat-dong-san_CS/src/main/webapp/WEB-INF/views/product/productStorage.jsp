							...
							<div class="b_qb_div">
								<div class="flex_FAQ_UpdateArea">
									...
									<div id="FAQ_Update_confirmBTN" >
										<input type="button" id="FAQ" value="확인" onClick="FAQsubmit(2)">
									</div>
								</div>	
								<div class="b_question ll">
									  <input type="hidden" value="${ FAQ.bId }">
									Q.<textarea  id="FAQ_Q_TextArea" class="TA" b_title="${ FAQ.bTitle }"  readOnly name="updatebTitle">${ FAQ.bTitle }</textarea>
								</div> 
...
//     		}
    		if(index == 2){
    			//document.FAQForm.action='FAQUpdate.board';
    		}
