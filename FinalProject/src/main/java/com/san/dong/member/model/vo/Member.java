...
public class Member {
	...
	public Member(String us_id, String us_pwd, String us_name, String us_ssn, String us_phone, String us_email,
			String us_addr, String us_type, Date us_reg_d, String us_kakao, String us_del_yn) {
		super();
		this.us_id = us_id;
		this.us_pwd = us_pwd;
	...
	public String toString() {
		return "Member [us_id=" + us_id + ", us_pwd=" + us_pwd + ", us_name=" + us_name + ", us_ssn=" + us_ssn
				+ ", us_phone=" + us_phone + ", us_email=" + us_email + ", us_addr=" + us_addr + ", us_type=" + us_type
				+ ", us_reg_d=" + us_reg_d + ", us_kakao=" + us_kakao + ", us_del_yn=" + us_del_yn + "]";
	}
