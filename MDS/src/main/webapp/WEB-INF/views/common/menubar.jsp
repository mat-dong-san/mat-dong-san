...
<body>
	...
	<div class="loginArea" align="right">
		...
		<c:if test="${ !empty sessionScope.loginUser }">
			...
			<c:url var="findRoom" value="findRoom.me"/>
			<c:url var="raiseRoom" value="raiseRoom.me"/>
			<c:url var="interest" value="interest.me"/>
			<c:url var="market" value="market.me"/>
			<c:url var="customer" value="customer.me"/>
	...
	<ul class="navbar_menu">
		<li onclick='${findRoom}'>방찾기</li>
		<li onclick='${raiseRoom}'>매물올리기</li>
